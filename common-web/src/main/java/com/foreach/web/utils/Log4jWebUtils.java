...
public final class Log4jWebUtils {
    ...
    public String getLoggersHtml(String applicationName, String formAction) {
        ...
        output.append("<html><head><title>Manage Loggers - ").append(applicationName).append("</title></head><body>");
        ...
        output.append("<tr><td colspan='7'>&nbsp;</td></tr>")
                .append("<tr><td align='center' colspan='7'><input type='reset' value='Reset'><input type='submit' value='Save'></td></tr>");
        output.append("</table>");
        output.append("</form>");
