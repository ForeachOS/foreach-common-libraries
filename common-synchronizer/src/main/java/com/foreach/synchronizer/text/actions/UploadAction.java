...
public class UploadAction implements SynchronizerAction {
    ...
    public Options getCliOptions() {
        ...
        options.addOption( SHORT_OPTION_INPUT_DIR, OPTION_INPUT_DIR, true, "the input directory to get the files from" );
        options.addOption( SHORT_OPTION_FORMAT, OPTION_FORMAT, true, "the input format (default=" + DEFAULT_FORMAT.name() + ")" );
        return options;
    }
    ...
    public void upload( String inputDirectory, LocalizedTextFormat format ) {
