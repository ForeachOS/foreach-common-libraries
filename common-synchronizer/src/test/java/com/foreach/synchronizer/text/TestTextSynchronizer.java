...
public class TestTextSynchronizer
{
	...
	public void execute() throws ParseException {
		...
		options.addOption( DownloadAction.SHORT_OPTION_OUTPUT_DIR, DownloadAction.OPTION_OUTPUT_DIR, true,
	...
	public void executeMissingArgument() {
		...
		Option option = new Option( DownloadAction.SHORT_OPTION_OUTPUT_DIR, DownloadAction.OPTION_OUTPUT_DIR, true,
		                            "the output directory to save the files to" );
