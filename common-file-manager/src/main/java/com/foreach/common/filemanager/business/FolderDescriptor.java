...
/**
 * Represents a {@link FolderResource} in a specific {@link FileRepository}.
 *
...
public class FolderDescriptor implements FileRepositoryResourceDescriptor
{
	...
	public Optional<FolderDescriptor> getParentFolderDescriptor() {
		...
		String parentFolderId = StringUtils.substringBeforeLast( folderId, "/" );
	...
	public static FolderDescriptor of( @NonNull String uri ) {
		String[] parts = StringUtils.split( StringUtils.removeStart( uri, FileDescriptor.PROTOCOL ), ":" );
	...
	public static FolderDescriptor of( @NonNull String repositoryId, String folderId ) {
		...
		String id = StringUtils.removeStart( StringUtils.removeEnd( StringUtils.defaultIfEmpty( StringUtils.replace( folderId, "\\", "/" ), "/" ), "/" ), "/" );
