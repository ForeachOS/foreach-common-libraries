...
/**
 * Represents a single {@link FileRepository} file,
 * identified by a {@link com.foreach.common.filemanager.business.FileDescriptor}. Can be used to read or manipulate the file (including update and delete).
 *
